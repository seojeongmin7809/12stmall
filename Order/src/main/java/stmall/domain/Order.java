...
public class Order {
    ...
    public static void nodifyToWaitingUser(StockIncreased stockIncreased) {
        /** Example 1:  new item 
    ...
    public static void updateStatus(DeliveryCanclled deliveryCanclled) {
        /** Example 1:  new item 
        Order order = new Order();
        repository().save(order);
        ...
        */
        ...
        repository().findById(deliveryCanclled.get???()).ifPresent(order->{
