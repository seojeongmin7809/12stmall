...
import stmall.domain.DeliveryCanclled;
...
public class Delivery {
    ...
    public static void deleveryStart(OrderPlaced orderPlaced) {
        /** Example 1:  new item 
    ...
    public static void deliveryCancel(OrderCancelled orderCancelled) {
        ...
        DeliveryCanclled deliveryCanclled = new DeliveryCanclled(delivery);
        deliveryCanclled.publishAfterCommit();
        */
